...
function setSliderButtonsState(slider) {
    ...
    if (slidesContainer == null)
        throw "Missing slides-container element in slider";
    const leftButton = slider.getElementsByClassName('slider-button-left')[0];
    if (leftButton == null)
        throw "Missing slider-button-left element in slider";
    const rightButton = slider.getElementsByClassName('slider-button-right')[0];
    if (rightButton == null)
        throw "Missing slider-button-right element in slider";
